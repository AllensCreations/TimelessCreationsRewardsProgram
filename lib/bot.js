...
export async function checkDashboardRateLimit(senderId) {
  try {
    ...
    const currentCount = updatedRows[0]?.view_count || 1;
...
// Generate Catalog Carousel with Unicode Progress Bars
...
// Formatted Dashboard Text Message
...
(When fellow missionaries verify using your code, you BOTH receive +1 Reward Point instantly!) 🚀"`;
  ...
  return { dashboardText, invitePromoText };
}
