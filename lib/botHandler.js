...
export async function handleBotMessage(psid, rawMessage = '', payload = null, referralParam = '') {
  ...
  // Normalization Layer for Actions
  ...
  // 3. Terms Acceptance Routing (Instant Execution)
  if (isAgreeAction) {
...
${defaultCode}`;
  ...
  // 4. Check if Missionary is Already Verified
  ...
  // 5. Unverified Onboarding State Engine
