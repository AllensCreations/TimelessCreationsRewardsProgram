...
export const JSDELIVR_BASE = "https://cdn.jsdelivr.net/gh/AllensCreations/TimelessCreationsRewardsProgram@NewVersion/public";
...
export function getCdnImageUrl(urlOrPath, fallbackName = "image.jpg") {
  ...
  // Heal stale deleted branch references
  if (trimmed.includes("@Appversion")) {
    trimmed = trimmed.replace(/@Appversion/g, "@NewVersion");
  }
