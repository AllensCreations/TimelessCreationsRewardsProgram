...
export function getCdnImageUrl(urlOrPath, fallbackName = "image.jpg") {
  ...
  // Already a jsDelivr CDN URL or Cloudflare R2 worker URL
  if (trimmed.includes("cdn.jsdelivr.net") || trimmed.includes("workers.dev") || trimmed.includes(".r2.cloudflarestorage.com")) {
    return trimmed;
  }
