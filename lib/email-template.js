export function generateMasterEmailHtml({ name, lastName, suffix, month, theme, scripture, quoteAuthor, message, points, referralCode, displayDate }) {
  const cleanLastName = lastName || (name ? name.replace(/^(Elder|Sister)\s+/i, '') : 'Missionary');
  ...
  const shareLink = `https://m.me/timeless.creations.06?ref=${referralCode || 'TCRP'}`;
...
<head>
    ...
    <style>
        ...
        .rewards-box {
            ...
            border: 1px dashed #d4c197;
            padding: 16px 12px;
            margin: 20px 0;
            text-align: center;
        }
        .rewards-title { font-family: 'Helvetica', Arial, sans-serif; font-size: 9px; letter-spacing: 2px; text-transform: uppercase; color: #8c7e5d; margin-bottom: 4px; }
        .rewards-pts { font-size: 22px; font-weight: bold; color: #1a1a1a; margin: 4px 0; }
        .rewards-code { font-family: 'Helvetica', Arial, sans-serif; font-size: 11px; color: #555; }
        ...
        @media (prefers-color-scheme: dark) {
            ...
            .logo-text, .greeting, .conference-quote, .monthly-message, .section-title, .rewards-pts { color: #ffffff !important; }
            .quote-container, .rewards-box { background-color: #1a1a1a !important; }
            ...
            .rewards-code { color: #aaa !important; }
        }
    </style>
</head>
<body>
...
<div class="email-wrapper">
    <div class="email-container">
        <div class="brand-header">
            <span class="date-badge">${cleanDate} • Month ${month}</span>
        ...
        <div class="main-content">
            <div class="greeting">Hello ${cleanSuffix} ${cleanLastName},</div>
            <div class="monthly-message">
                ${message}
            </div>

            <div class="quote-container">
                <span class="conference-quote">“${scripture}”</span>
                <div class="quote-author">${quoteAuthor || theme}</div>
            </div>

            <div class="rewards-box">
                <div class="rewards-title">Your Rewards Balance</div>
                <div class="rewards-pts">${points || 0} Point(s)</div>
                <div class="rewards-code">Invite Code: <strong>${referralCode || 'TCRP'}</strong></div>
            </div>
            ...
            <div class="promo-section">
                ...
                <a href="${shareLink}" class="cta-button">Open Rewards Hub / Order</a>
            </div>
            ...
            <div style="max-width: 420px; margin: 40px auto; text-align: center; padding: 0 15px;">
                ...
                <div style="margin-bottom: 25px;">
                    ...
                    <a href="https://photos.app.goo.gl/6h7UPfkHU5TuvzXU7" 
                       style="display: inline-block; padding: 12px 25px; border: 1px solid #1a1a1a; color: #1a1a1a !important; text-decoration: none; font-family: 'Helvetica', Arial, sans-serif; font-size: 10px; text-transform: uppercase; letter-spacing: 2px; font-weight: bold;">
                        Enter the Gallery
                    </a>
                </div>
            </div>
        ...
        <div class="footer">
            ...
            <a href="https://m.me/timeless.creations.06" style="display:block;margin-top:15px;font-family:Georgia,'Times New Roman',serif;font-size:11px;color:rgba(255,255,255,0.28);text-decoration:none;letter-spacing:1px;text-transform:uppercase;">Unsubscribe from monthly letters</a>
        </div>
    </div>
</div>
