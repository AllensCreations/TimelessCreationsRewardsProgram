...
export async function sendEmail({ to, subject, htmlContent }) {
  ...
  // Guard: Check if system is offline
  try {
...
export function buildCombinedRewardAndPromoHtml(points = 2, products = [], activePromo = null) {
...
export function renderMonthlyDripTemplate(dripData = {}, rewardProducts = [], activePromo = null) {
  ...
  const rewardSectionHtml = buildCombinedRewardAndPromoHtml(points, rewardProducts, activePromo);
