...
export function buildRewardSectionHtml(points = 2, products = []) {
  ...
  // State 1: User has affordable items
  ...
  // State 2: Catalog has items, but user needs more points for nearest goal
  ...
  // State 3: Catalog is empty (Option 3 - Motivating Community Empty State)
  else {
    claimBoxContent = `
