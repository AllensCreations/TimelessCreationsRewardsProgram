 ...
 */
export function clearDebounce(psid = null) {
  if (!psid) {
...
// Max 5 messages per 60 seconds (Warn Once + Silent Drop)
// ----------------------------------------------------
export async function checkBurstRateLimit(psid, limit = 5, windowSeconds = 60) {
